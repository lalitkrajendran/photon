...
# set filepath
filepath = '/home/barracuda/a/lrajendr/Projects/camera_simulation/data/bos_parameters/dof/'
...
for i in range(0,dot_size_microns.size): #len(dot_size_microns)):
    ...
    piv_simulation_parameters['bos_pattern']['X_Min'] = -field_of_view/2
    piv_simulation_parameters['bos_pattern']['X_Max'] = +field_of_view/2

    piv_simulation_parameters['bos_pattern']['Y_Min'] = -field_of_view/2
    piv_simulation_parameters['bos_pattern']['Y_Max'] = +field_of_view/2
    ...
    top_write_directory = '/home/barracuda/a/lrajendr/Projects/camera_simulation/results/images/bos/error-analysis/dof/'
    ...
    for image_pair_index in range(0,number_of_image_pairs):
        ...
        piv_simulation_parameters['output_data']['bos_pattern_image_directory'] = top_write_directory + 'f%d/' % f_number
        ...
        piv_simulation_parameters['density_gradients'][
            'density_gradient_filename'] = '/home/barracuda/a/lrajendr/Projects/parallel_ray_tracing/data/const_grad_BOS_grad_x_5.00_zmin_200_zmax_400.nrrd'
