...
focal_length_array=(100 125 150 175 200 225 250 275 300)

for grad_x in ${grad_x_array[*]}
do
	for focal_length in ${focal_length_array[*]}
	do
		echo $grad_x $focal_length

		# this is the top write directory
		top_write_directory=/home/barracuda/a/lrajendr/Projects/camera_simulation/results/images/bos/error-analysis/magnification/grad_x=$grad_x/$focal_length
