...
read_filepath = '/home/barracuda/a/lrajendr/Projects/camera_simulation/results/images/bos/error-analysis/blur/150x150-f8-dotsize300-blur0.10/';

% load data
data = load([read_filepath 'PIV_pass1_corrplanes_1.mat']);
% data = load([read_filepath 'PIV_pass1_1.mat']);
