...
read_filepath = '~/Projects/camera_simulation/test_directory/prana_processing/cam2cam4/piv_results/Willert/Camera2Camera4_3Cfields/';
% this is the name of the file which contains the results
read_filename = 'piv_2d3c_cam2cam4_pass_1_0001.mat';

% this is the path to the folder where the plots will be saved
write_filepath = '~/Projects/camera_simulation/test_directory/prana_processing/cam2cam4/piv_results/';
...
figure(4)
subplot(3,1,1), histogram(results.U(:))
title(['U (U_{ref} = ' num2str(U_ref) ')'])
subplot(3,1,2), histogram(results.V(:))
title(['V (V_{ref} = ' num2str(V_ref) ')'])
