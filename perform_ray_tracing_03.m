function I=perform_ray_tracing_03(piv_simulation_parameters,optical_system,pixel_gain,scattering_data,scattering_type,lightfield_source,field_type);
...
% 
% save('reference_parameters.mat','image_distance','h2_principal_plane','v2_vertex_plane','v1_vertex_plane','z_sensor','z_lens','lens_pitch',...
%     'elements_coplanar','element_type','element_count','element_data','element_center','element_plane_parameters','element_system_index');

% load('reference_parameters.mat');
...
load(loadfilename);
% temp = element_data{1,2};
% element_data = cell(1,1);
% element_data{1,1} = temp;
element_data{1,1}.element_number = [];
element_data{1,1}.elements_coplanar = [];
element_data{1,1}.element_properties.abbe_number = [];
...
% lightray_number_per_particle = 3;
% lightray_process_number = 3;
