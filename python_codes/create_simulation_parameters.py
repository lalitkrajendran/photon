...
def create_simulation_parameters(simulation_type):
    ...
    piv_simulation_parameters['simulation_type'] = simulation_type
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    piv_simulation_parameters['lens_design']['lens_radius_of_curvature'] = 100e3 #100000.0e3
    ...
    piv_simulation_parameters['lens_design']['ray_cone_pitch_ratio'] = 1e-4
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    piv_simulation_parameters['camera_design']['intensity_rescaling'] = True
    if simulation_type == 'piv':
        ...
        piv_simulation_parameters['particle_field']['load_particle_data'] = False
    ...
    piv_simulation_parameters['density_gradients']['density_gradient_filename'] = ''
    # ray tracing algorithm (1 - euler, 2 - rk4, 3 - rk45, 4 - adams-bashforth)
    piv_simulation_parameters['density_gradients']['ray_tracing_algorithm'] = 1
    # %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    piv_simulation_parameters['output_data']['crop_image'] = False
    # option to save light ray
    piv_simulation_parameters['output_data']['save_lightrays'] = False
...
def create_single_parameter_file():
    ...
    piv_simulation_parameters = create_simulation_parameters()
